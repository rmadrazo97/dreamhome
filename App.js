        ...
        return (
            <View style={styles.viewStyles}>
                <Image
                    ...
                    // style={styles.logo}
                    style={[{width:90, height:90, alignSelf: 'center', marginBottom: 15}]}
                    resizeMode="contain"
                />
            </View>
        );
...
function OfflineScreen(props) {
    return (
        <View style={[styles.viewStyles,{paddingHorizontal: 40}]}>
            ...
            <TextHeavy style={{color: props.apColors.tText, fontSize: 24,lineHeight:41,textAlign:'center',marginBottom:20}}>Sin conexión de</TextHeavy>
            <TextRegular style={{color: props.apColors.tText, fontSize:17,lineHeight:21,textAlign:'center'}}>Parece que no estas conectado al internet.</TextRegular>
            <TextRegular style={{color: props.apColors.tText, fontSize:17,lineHeight:21,textAlign:'center'}}>Asegúrese de que su Wi-Fi o datos móviles estén activados, el modo avión esté desactivado y vuelva a intentarlo.</TextRegular>
            <BtnLarge bordered disabled={false} style={{alignSelf:'center', marginVertical: 10,marginTop:30}} onPress={props.onRetry}>Intentar de nuevo</BtnLarge>
        </View>
    );
}
