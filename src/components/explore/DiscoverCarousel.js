    ...
    render () {
        ...
        return (
            <View style={[styles.container,_self.props.style]}>
                ...
                />
                <TouchableOpacity style={styles.menuItem} onPress={()=>this._onNearBy()}>
                    <View style={{flexDirection: 'row', justifyContent: 'center'}}>
                        <View style={{ 
                            ...
                            shadowOpacity: 0.25,
                            shadowRadius: 3.84,
                            elevation: 5, paddingRight: 10,
                            paddingLeft: 10, paddingTop: 4,
                            paddingBottom: 4, borderRadius: 15,
                            flexWrap: 'wrap', flexDirection: 'row',
                            backgroundColor:'#2E3F6E' ,
                            alignItems: 'center', marginTop: 10}}
                        >
                            <TextRegular style={{fontSize: 15,textAlign:'center',lineHeight:20, marginTop: 3, color: 'white'}}>
                                {translate('nearme')}
                            </TextRegular>
                            <MarkerSvg style={{marginLeft: 5, marginRight: 3}} color="white" />
                        </View>
                    </View>
                </TouchableOpacity>
            </View>
