...
export const AvatarSvg = (props: any): any => {
  	return (
...
export const ArrowLeftSvg = (props: any): any => {
  	return (
...
export const CloseSvg = (props: any): any => {
  	return (
...
export const ShareSvg = (props: any): any => {
  	return (
...
export const MoreSvg = (props: any): any => {
  	return (
...
export const GoDetailsSvg = (props: any): any => {
  	return (
...
export const ArrowDetailsSvg = (props: any): any => {
  	return (
...
export const NotificationsSvg = (props: any): any => {
	const colors = getThemedColors(useColorScheme())
  	return (
  		<Svg width={30} height={30} viewBox="0 0 30 30" {...props}>
	      	<G transform="translate(0 .6)" fill="none" fillRule="evenodd">
	        	<Rect fill={colors.appColor} width={30} height={30} rx={12} />
		        <Path
...
export const CardsSvg = (props: any): any => {
  	return (
...
export const CurrencySvg = (props: any): any => {
  	return (
	  	<Svg width={29} height={30} viewBox="0 0 29 30" {...props}>
...
export const LanguageSvg = (props: any): any => {
	const colors = getThemedColors(useColorScheme())
  	return (
	  	<Svg width={30} height={30} viewBox="0 0 30 30" {...props}>
	      	<G fill="none" fillRule="evenodd">
...
export const TermsSvg = (props: any): any => {
	const colors = getThemedColors(useColorScheme())
  	return (
	  	<Svg width={30} height={30} viewBox="0 0 30 30" {...props}>
	      	<G transform="translate(0 .5)" fill="none" fillRule="evenodd">
...
export const PrivacySvg = (props: any): any => {
	const colors = getThemedColors(useColorScheme())
  	return (
	  	<Svg width={30} height={30} viewBox="0 0 30 30" {...props}>
	      	<G fill="none" fillRule="evenodd">
...
export const HelpCenterSvg = (props: any): any => {
	const colors = getThemedColors(useColorScheme())
  	return (
	  	<Svg width={30} height={30} viewBox="0 0 30 30" {...props}>
	      	<G fill="none" fillRule="evenodd">
...
export const AboutUsSvg = (props: any): any => {
	const colors = getThemedColors(useColorScheme())
  	return (
	  	<Svg width={30} height={30} viewBox="0 0 30 30" {...props}>
	      	<G fill="none" fillRule="evenodd">
	        	<Rect width={30} height={30} rx={12} fill={colors.appColor} />
	        	<Path
...
// home profile screen
export const SearchSvg = (props: any): any => {
  	return (
...
// edit profile screen
export const PhotoSvg = (props: any): any => {
  	return (
...
// bookmarks screen
export const BookmarkSvg = (props: any): any => {
	const colors = getThemedColors(useColorScheme())
  	return (
...
export const MarkerSvg = (props: any): any => {
  	return (
...
export const FilterSvg = (props: any): any => {
  	return (
  		<Svg width={20} height={16} viewBox="0 0 20 16" {...props}>
	      	<Path
...
export const CheckMarkSvg = (props: any): any => {
  	return (
...
export const CatSvg = (props: any): any => {
  	return (
  		<Svg width={20} height={20} viewBox="0 0 20 20" {...props}>
	      	<Path
...
export const LightningSvg = (props: any): any => {
  	return (
...
export const PinterSvg = (props: any): any => {
  	return (
  		<Svg width={18} height={20} viewBox="0 0 18 20" {...props}>
	      	<Path
...
export const ChatSvg = (props: any): any => {
  	return (
  		<Svg width={20} height={20} viewBox="0 0 20 20" {...props}>
	      	<Path
...
export const ClockSvg = (props: any): any => {
  	return (
  		<Svg width={20} height={20} viewBox="0 0 20 20" {...props}>
	      	<Path
...
export const SendSvg = (props: any): any => {
  	return (
  		<Svg width={20} height={20} viewBox="0 0 20 20" {...props}>
	      	<Path
...
export const SendHozSvg = (props: any): any => {
  	return (
...
export const ChatProfileSvg = (props: any): any => {
	const colors = getThemedColors(useColorScheme())
  	return (
...
export const EditSvg = (props: any): any => {
  	return (
...
export const MapSvg = (props: any): any => {
  	return (
  		<Svg width={20} height={16} viewBox="0 0 20 16" {...props}>
		  	<Path
...
export const WifiSlash = (props: any): any => {
  	return (
