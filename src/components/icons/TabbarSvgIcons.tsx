...
export const ExploreSvg = (props: any): any => {
  	return (
...
export const BookingsSvg = (props: any): any => {
  	return (
  		<Svg width={23} height={22} viewBox="0 0 23 22" {...props}>
	      	<Path
...
export const BookmarksSvg = (props: any): any => {
  	return (
...
export const ProfileSvg = (props: any): any => {
  	return (
