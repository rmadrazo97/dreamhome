...
export default class RoomImages extends React.Component{
  	constructor(props){
	    super(props)
        this.state = {
            showGal: false,
  		...
  		return(
            <View style={[styles.container, this.props.style]}>
                <TouchableOpacity
                    ...
                    <TextMedium style={{color: apColors.tText, fontSize: 15,marginTop: 10,}}>{translate('slisting','view_room_images')}</TextMedium>
                </TouchableOpacity>
                <Modal
                  transparent={false}
                  animationType={'fade'}
