...
class ChatScreen extends React.Component{
    ...
    onSelect(reply){
        ...
        // this.props.navigation.navigate( 'ReplyNew', {backRoute: 'ChatScreen', cid, crid, display_name, touid, fuid: user_one } )
        // this.props.navigation.navigate('Reply', { screen: 'ChatScreen', params: { cid, crid, display_name, touid, fuid: user_one }  });
        this.props.navigation.navigate( 'ReplyNew', { cid, crid, display_name, touid, fuid: user_one } )
        ...
        >  
            <View style={styles.contactInner}>
                ...
                <View style={styles.contactDetails}>
                    ...
                    { replyText !== '' && <HTML  source={{ html: replyText }}
                    // html={replyText}
