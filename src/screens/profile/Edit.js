...
class EditProfile extends React.Component {
        ...
        successButton() {
            return ( <
                ...
                onPress = {
                    () => {
                        this.props.profileClosePopup();
                        this.props.navigation.goBack()
                    }
                } > { translate('editprofile', 'done') } < /BtnLarge>
            )
        }
        render() {
            ...
            return ( <
                SafeAreaConsumer style = {
                    { flex: 1 }
                } > {
                    insets => < View style = {
                        [styles.container, { backgroundColor: apColors.appBg, paddingLeft: insets.left, paddingRight: insets.right, paddingBottom: insets.bottom }]
                    } >

                    {
                        ...
                        <
                        SuccessPopup visible = { submitted }
                        title = { popTitle }
                        message = { popMsg }
                        ...
                        <
                        View style = {
                            [styles.avatarWrap, { shadowColor: apColors.shadowCl, }]
                        } > {
                            avatar && < Image
                            source = {
                                { uri: avatar }
                        ...
                        /View> <
                        View style = {
                            [styles.photoIconWrap, { backgroundColor: apColors.appColor, }]
                        } >
                        <
                        PhotoSvg / >
                        <
                        ...
                        <
                        TextRegular style = {
                            [styles.fieldLabel, { color: apColors.fieldLbl, }]
                        } > { translate('editprofile', 'fname') } < /TextRegular> <
                        TextInput
                        style = {
                            [styles.textInput, { borderColor: apColors.separator, color: apColors.pText }]
                        }
                        ...
                        <
                        TextRegular style = {
                            [styles.fieldLabel, { color: apColors.fieldLbl, marginTop: 40 }]
                        } > { translate('editprofile', 'lname') } < /TextRegular> <
                        TextInput
                        style = {
                            [styles.textInput, { borderColor: apColors.separator, color: apColors.pText }]
                        }
                        ...
                        TextRegular style = {
                            [styles.fieldLabel, { color: apColors.fieldLbl, marginTop: 40 }]
                        } > { translate('editprofile', 'dname') } < /TextRegular> <
                        TextInput
                        style = {
                            [styles.textInput, { borderColor: apColors.separator, color: apColors.pText }]
                        }
                        ...
                        TextRegular style = {
                            [styles.fieldLabel, { color: apColors.fieldLbl, marginTop: 40 }]
                        } > { translate('editprofile', 'email') } < /TextRegular> <
                        TextInput
                        style = {
                            [styles.textInput, { borderColor: apColors.separator, color: apColors.pText, color: apColors.addressText }]
                        }
                        ...
                        TextRegular style = {
                            [styles.fieldLabel, { color: apColors.fieldLbl, marginTop: 40 }]
                        } > { translate('editprofile', 'contact_email') } < /TextRegular> <
                        TextInput
                        style = {
                            [styles.textInput, { borderColor: apColors.separator, color: apColors.pText }]
                        }
                        ...
                        TextRegular style = {
                            [styles.fieldLabel, { color: apColors.fieldLbl, marginTop: 40 }]
                        } > { translate('editprofile', 'description') } < /TextRegular> <
                        TextInput
                        style = {
                            [styles.textInput, { borderColor: apColors.separator, color: apColors.pText, minHeight: 85 }]
                        }
                        ...
                        TextRegular style = {
                            [styles.fieldLabel, { color: apColors.fieldLbl, marginTop: 40 }]
                        } > { translate('editprofile', 'birth') } < /TextRegular>

                        <
                        TouchableOpacity style = {
                            [styles.dateTimeInput, { borderColor: apColors.separator, }]
                        }
                        onPress = {
                            () => this.onShowDatePicker('date_of_birth')
                        } >
                        <
                        TextHeavy style = {
                            { fontSize: 17, color: apColors.pText }
                        } > { date_of_birth } < /TextHeavy> < /
                        TouchableOpacity >

                        <
                        TextRegular style = {
                            [styles.fieldLabel, { color: apColors.fieldLbl, marginTop: 40 }]
                        } > { translate('editprofile', 'phone') } < /TextRegular> <
                        TextInput
                        style = {
                            [styles.textInput, { borderColor: apColors.separator, color: apColors.pText }]
                        }
                        ...
                        TextRegular style = {
                            [styles.fieldLabel, { color: apColors.fieldLbl, marginTop: 40 }]
                        } > { translate('editprofile', 'address') } < /TextRegular> <
                        TextInput
                        style = {
                            [styles.textInput, { borderColor: apColors.separator, color: apColors.pText }]
                        }
                        ...
                        TextRegular style = {
                            [styles.fieldLabel, { color: apColors.fieldLbl, marginTop: 40 }]
                        } > { translate('editprofile', 'company') } < /TextRegular> <
                        TextInput
                        style = {
                            [styles.textInput, { borderColor: apColors.separator, color: apColors.pText }]
                        }
                        ...
                        TextRegular style = {
                            [styles.fieldLabel, { color: apColors.fieldLbl, marginTop: 40 }]
                        } > { translate('editprofile', 'website') } < /TextRegular> <
                        TextInput
                        style = {
                            [styles.textInput, { borderColor: apColors.separator, color: apColors.pText }]
                        }
                        ...
                        <
                        BtnFull disabled = { submitting }
                        style = {
                            [{ marginLeft: 15, marginRight: 15 }, submittedBtn]
                        }
                        onPress = {
                            () => this._onSubmit({})
                        } > { translate('editprofile', 'save') } < /BtnFull> < /
                        View >
                        ...
                        showDatePicker && ( <
                            ...
                            <
                            TouchableOpacity style = { styles.datePickerSave }
                            onPress = {
                                () => this.onHideDatePicker()
                            } >
                            <
                            TextMedium style = {
                                { fontSize: 17, color: apColors.appColor, textAlign: 'right' }
                            } > { translate('editprofile', 'save') } < /TextMedium> < /
                            TouchableOpacity > <
